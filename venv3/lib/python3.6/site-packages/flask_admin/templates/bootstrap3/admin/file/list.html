    ...
    <table class="table table-striped table-bordered model-list">
        ...
        <tr>
            ...
            <th>
                ...
                {% else %}
                <a href="{{ sort_url(column) }}" title="{{ _gettext('Sort by %(name)s', name=column) }}">{{
                    admin_view.column_label(column) }}</a>
                {% endif %}
                {% else %}
...
<div class="btn-toolbar">
    ...
    <div class="btn-group">
        ...
        {% else %}
        <a class="btn btn-default btn-large" href="{{ get_dir_url('.upload', path=dir_path) }}">{{ _gettext('Upload
            File') }}</a>
        {%- endif -%}
    </div>
    {% endif %}
    ...
    <div class="btn-group">
        ...
        {% else %}
        <a class="btn btn-default btn-large" href="{{ get_dir_url('.mkdir', path=dir_path) }}">{{ _gettext('Create
            Directory') }}</a>
        {%- endif -%}
    </div>
    {% endif %}
